...
public class Combination extends Pair<SortedSet<String>, Integer> {
     ...
     * @return true if the objects are equal in terms of their content, otherwise
     *         false.
     */
    @Override
     ...
     *
     * @return The hash code based on the content of the first and second
     *         attributes.
     */
    @Override
    public int hashCode() {

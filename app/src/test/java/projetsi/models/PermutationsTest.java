...
class PermutationsTest {
        ...
        void PermutationsTestLimitSize() {
                ...
                assertTrue(allCombinationsHaveAtMostFourKeywords,
                                "Should be true if all combinations have at most 4 keywords");
                assertTrue(shouldBeTrueIfCombinationsAreEqual, "Should be true if all the combinations are found");
        }
        ...
        private List<Combination> create4setMockCombinationList() {
                ...
                combinationsList.add(
                                new Combination(new TreeSet<>(Arrays.asList("national", "president", "rouge")), 0));

                // Permutations de taille 4
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "national", "president", "rouge")), 0));
        ...
        private List<Combination> create5setMockCombinationList() {
                ...
                combinationsList.add(new Combination(new TreeSet<>(Arrays.asList("euro", "president", "rouge")), 0));
                combinationsList.add(
                                new Combination(new TreeSet<>(Arrays.asList("france", "national", "president")), 0));
                ...
                // Permutations de taille 4
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "france", "national", "president")), 0));
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "france", "national", "rouge")), 0));
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "france", "president", "rouge")), 0));
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "national", "president", "rouge")), 0));
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("france", "national", "president", "rouge")), 0));

                // Permutations de taille 5
                combinationsList.add(new Combination(
                                new TreeSet<>(Arrays.asList("euro", "france", "national", "president", "rouge")), 0));
